                    ...
                    <div class="text-center mb-1">
                        ...
                        <div class="mt-4 text-center">
                            <?php if (isset($_SERVER['HTTP_REFERER'])) : ?>
                                <a class="btn btn-secondary waves-effect waves-light me-2" href="<?= $_SERVER['HTTP_REFERER'] ?>">Previous</a>
                            <?php endif; ?>
                            <a class="btn btn-primary waves-effect waves-light me-2" href="<?= base_url('home') ?>">Back to Home</a>
                        </div>
                    </div>
                </div>
            </div>
