...
<button type="button" id="btn_draw_rectangle" class="btn btn-light btn-sm d-none waves-effect waves-light" title="Rectangle" onclick="changeModeDraw('draw_rectangle')">
    <i class="bx bx-rectangle font-size-18 align-middle" style="font-weight: 800 !important;"></i>
</button>
<button type="button" id="btn_draw_circle" class="btn btn-light btn-sm d-none waves-effect waves-light" title="Circle" onclick="changeModeDraw('draw_circle')">
    ...
    function getAPI(lngLat){
        geoAPIgoogle(lngLat).then((data) => {
            ...
            if (!checkProp && prop.isCircle) {
                geocodeToDataTable.push({'no': no+=1, 'key': 'isCircle', 'value': prop.isCircle, 'action': '<button disabled class="btn btn-outline-danger btn-sm delete" title="Delete"><i class="fas fa-trash-alt"></i></button>'});
                geocodeToDataTable.push({'no': no+=1, 'key': 'radiusInKm', 'value': prop.radiusInKm, 'action': '<button disabled class="btn btn-outline-danger btn-sm delete" title="Delete"><i class="fas fa-trash-alt"></i></button>'});
                geocodeToDataTable.push({'no': no+=1, 'key': 'center', 'value': prop.center.toString(), 'action': '<button disabled class="btn btn-outline-danger btn-sm delete" title="Delete"><i class="fas fa-trash-alt"></i></button>'});
            }
