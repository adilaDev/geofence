...
<!-- <script src="<?= base_url('vendor/mapbox-gl-draw-circle-master/lib/modes/DirectModeOverride.js?v=').time() ?>"></script>
<script src="<?= base_url('vendor/mapbox-gl-draw-circle-master/lib/modes/DragCircleMode.js?v=').time() ?>"></script>
<script src="<?= base_url('vendor/mapbox-gl-draw-circle-master/lib/modes/SimpleSelectModeOverride.js?v=').time() ?>"></script> -->
<!-- <script src="<?= base_url('vendor/mapbox-gl-draw-circle-master/lib/modes/mapboxdraw-circle.js?v=').time() ?>"></script> -->
