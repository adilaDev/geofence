...
<!-- <script>
    ...
    function getBrowserUser() {
        ...
        return { "userAgent": userAgent, "vendor": vendor, "device": getDeviceType() };
    }
...
<script>
    ...
    map.addControl(new mapboxgl.AttributionControl({
        customAttribution: `<?= !empty($this->lang->line('footer_mapbox_jp')) ? $this->lang->line('footer_mapbox_jp') : 'NULL'; ?>`
        ...
        if (uri2 == 'home' || uri2 == 'client' || uri2 == 'monitoring') {
            ...
            if (getSel.features.length === 0) {
                ...
                Swal.fire({
                    ...
                    confirmButtonText: '<?= !empty($this->lang->line('notice_no')) ? $this->lang->line('notice_no') : 'No, I want to save it'; ?>',
                    cancelButtonText: "<?= !empty($this->lang->line('notice_yes')) ? $this->lang->line('notice_yes') : 'Yes, I want to exit'; ?>",
